    ...
    if form.validate_on_submit():
        try:
            record = VisaRecord(
                ...
                hotel_file=form.hotel_file.data,
                ticket_file=form.ticket_file.data,
                bank_file=form.bank_file.data,
                passport_file=form.passport_file.data,
                pic_file=form.pic_file.data,
                other_docs=form.other_docs.data,
